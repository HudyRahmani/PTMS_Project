...
<head>
    ...
    <title>TRMS || Manage Teacher (Public Profile)</title>
            ...
            <div class="col-sm-5">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>مدیریت استادان(پروفایل آن عمومی است)</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-7">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-teacher.php">مدیریت استادان(پروفایل آن عمومی است)</a></li>
                            <li class="active"></li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div style="text-align:right;" class="card-header">
                                <strong class="card-title">مدیریت استادان(پروفایل آن عمومی است)</strong>
                            </div>
                            <div class="card-body">
