...
<head>
    ...
    <title>TRMS || Manage Teacher (poanyar Profile)</title>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div style="text-align:right;" class="card-header">
                                <strong class="card-title">مدیریت استادان که رتبه علمی آنها پوهنیار هستند</strong>
                            </div>
                            <div class="card-body">
				 ...
				 <th>عکس استاد</th>
                  <th>نام استاد</th>
                   ...
                   <th>عمل</th>
                                    ...
                                    <?php
$sql="SELECT * from tblteacher where sciencer='5'";
