...
<head>
    ...
    <title>مدیریت استادان (پروفایل آن عمومی نیست)</title>
            ...
            <div class="col-sm-5">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>مدیریت استادان(پروفایل آن عمومی نیست)</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-7">
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-teacher.php">مدیریت استادان(پروفایل آن عمومی نیست)</a></li>
                            <li class="active"> </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div style="text-align:right;" class="card-header">
                                <strong class="card-title">مدیریت استادان(پروفایل آن عمومی نیست)</strong>
                            </div>
                            <div class="card-body">
				 ...
				 <th>عکس استاد</th>
                  <th>نام استاد</th>
                   ...
                   <th>عمل</th>
                                    ...
                                    <?php
						$sql="SELECT * from tblteacher where isPublic is null || isPublic='0'";
