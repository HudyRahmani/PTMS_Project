...
$propic=md5($propic).time().$extension;
 move_uploaded_file($_FILES["newpic"]["tmp_name"],"../teacher/images/".$propic);
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-teacher.php">اپدیت عکس</a></li>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div style="text-align:right;" class="card-header"><small> اپدیت </small>عکس <strong></strong></div>
...
{               ?>
                                ...
                                <div class="form-group">
                                    <label for="company" class=" form-control-label">عکس پروفایل</label>
                                                                <?php if($row->Picture==''):?>
<img src="../teacher/images/no-image.png"  alt="NO Image">
<?php else: ?>    
<img src="../teacher/images/<?php echo $row->Picture;?>"  class="w-50 h-50"   value="<?php  echo $row->Picture;?>">
<?php endif;?>
                                </div>
                                <div class="form-group"><label for="company" class=" form-control-label">پروفایل جدید </label><input type="file" name="newpic" value="" class="form-control" id="newpic" required='true'></div>
