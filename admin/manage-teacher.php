...
$query->execute();
	header("location:manage-teacher.php?erorr=done");
  }
    ...
    <div id="right-panel" class="right-panel">
                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-teacher.php">مدیرت استادان</a></li>
                            <li class="active">مدیریت استادان</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div dir="rtl" style="text-align:right;" class="content mt-3">
            <div class="animated fadeIn">
                <div class="row">
                    <div class="col-lg-12">
					<?php if(isset($_GET["addt"])){ ?>
							<span  style="color:green;margin-right:10px;font-size:18px;">استاد به موفقیت ثبت شد</span>
						<?php } ?>
						<?php if(isset($_GET["erorr"])){ ?>
							<span  style="color:red;margin-right:10px;font-size:18px;">استاد به موفقیت حذف شده</span>
						<?php } ?>
						<?php if(isset($_GET["update"])){ ?>
							<span  style="color:green;margin-right:10px;font-size:18px;">مشخصات استاد به موفقیت اپدیت شد</span>
						<?php } ?>
						<?php if(isset($_GET["updateimage1"])){  ?>
							<span style="color:green;font-size:18">فوتوکاپی تذکره استاد به موفقیت اپدیت شد</span>
						<?php } ?>
						<?php if(isset($_GET["updateimage"])){  ?>
							<span style="color:green;font-size:18">عکس استاد به موفقیت اپدیت شده</span>
						<?php } ?>
                        <div class="card">
						
                            <div style="text-align:right;"  class="card-header">
                                <strong class="card-title">مدیریت استادان</strong>
                            </div>
                            <div class="card-body">
