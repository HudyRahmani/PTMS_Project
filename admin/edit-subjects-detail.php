                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="manage-subjects.php">پوهنځی</a></li>
                            <li class="active">ویرایش پوهنځی</li>
                        </ol>
                    </div>
                </div>
            </div>
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div  class="card">
                            <div style="text-align:right;" class="card-header"><small> جزیان </small><strong>پوهنځی </strong></div>
                            <form style="text-align:right;"  dir="rtl" name="" method="post" action="">
