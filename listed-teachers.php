...
<html lang="fa">
    <head>
        ...
        <meta name="author" content="هدی رحمانی" />
 ...
 <?php include_once('includes/header.php');?>
            ...
            <section class="py-2">
                <div class="container px-3 my-3">
					...
					<aside class="bg-primary bg-gradient rounded-3 p-3 p-sm-3 mt-2">
                        <div dir="rtl" class="d-flex align-items-center justify-content-between flex-column flex-xl-row text-center text-xl-start">
                    ...
                    <hr />
                    <div dir="rtl" class="row gx-5 justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            <div class="text-center">
                                <h2 class="fw-bolder">لیست تمام استادان</h2>
									<hr color="red" />
                            </div>
                        </div>
                    </div>
                    <div dir="rtl" class="row gx-5">
						...
						<?php }} else{?>
						<h3 align="center" dir="rtl" style="color:red;">پیدا نشد</h3>
						<?php } ?>
